...
class FarmsControllerTest < ActionController::TestCase
  ...
  test "should create farm" do
    assert_difference('Farm.count') do
      post :create, farm: { animal_id: @farm.animal_id, expense_id: @farm.expense_id, income_id: @farm.income_id, weather_id: @farm.weather_id }
    end
  ...
  test "should update farm" do
    patch :update, id: @farm, farm: { animal_id: @farm.animal_id, expense_id: @farm.expense_id, income_id: @farm.income_id, weather_id: @farm.weather_id }
    assert_redirected_to farm_path(assigns(:farm))
  end

...
class BreedsControllerTest < ActionController::TestCase
  ...
  test "should create breed" do
    assert_difference('Breed.count') do
      post :create, breed: { Animal_id: @breed.Animal_id, egg_id: @breed.egg_id, id: @breed.id, name: @breed.name }
    end
  ...
  test "should update breed" do
    patch :update, id: @breed, breed: { Animal_id: @breed.Animal_id, egg_id: @breed.egg_id, id: @breed.id, name: @breed.name }
    assert_redirected_to breed_path(assigns(:breed))
  end
